...
function attHora()
	...
	if Time.mes >= 0 and Time.mes <= 9 then
		Time.mes = "0"..Time.mes
	end
	Time.dia = tonumber(os.date("%d"))
	if Time.dia >= 0 and Time.dia <= 9 then
		Time.dia = "0"..Time.dia
	end
end
...
local carros = {
	...
	["acsr"] = { price = 100000 },
	["x6m"] = { price = 100000 },
	["718boxster"] = { price = 100000 },
	["zl12017"] = { price = 100000 },
	["rotacamu1"] = { price = 300000 },
	["c7"] = { price = 800000 },
	["srt8"] = { price = 100000 },
	...
	["bifta"] = { price = 190000 },
	["bodhi2"] = { price = 170000 },
	["hondacivictr"] = { price = 170000 },
	["718caymans"] = { price = 170000 },
	...
	["bestiagts"] = { price = 75000 },
	["hcbr17"] = { price = 75000 },
	["blista2"] = { price = 58000 },
	["blista3"] = { price = 70000 },
	["buffalo"] = { price = 64000 },
	["buffalo2"] = { price = 240000 },
	["carbonizzare"] = { price = 98000 },
	["comet2"] = { price = 200000 },
	["comet3"] = { price = 230000 },
	["coquette"] = { price = 98000 },
	["elegy"] = { price = 260000 },
	["elegy2"] = { price = 87000 },
	["feltzer2"] = { price = 115000 },
	["furoregt"] = { price = 80000 },
	...
	["ferrariitalia"] = { price = 150000 },
	["paganihuayra"] = { price = 150000 },
	["fordmustang"] = { price = 150000 },
	["fordmustanggt"] = { price = 150000 },
	["nissangtr"] = { price = 150000 },
	["nissangtrnismo"] = { price = 150000 },
	["teslaprior"] = { price = 150000 },
	["nissanskyliner34"] = { price = 150000 },
	["audirs6"] = { price = 150000 },
	["bmwm3f80"] = { price = 150000 },
	["bmwm4gts"] = { price = 150000 },
	["lancerevolutionx"] = { price = 150000 },
	["mercedesamgc63"] = { price = 150000 },
	["toyotasupra"] = { price = 150000 },
	["nissan370z"] = { price = 120000 },
	["lamborghinihuracan"] = { price = 150000 },
	["dodgechargersrt"] = { price = 150000 },
	["sanchez"] = { price = 450000 },
	...
	["tulip"] = { price = 300000 },
	["vamos"] = { price = 320000 },
	["mazdarx7"] = { price = 6200000 },
	["akuma"] = { price = 96000 },
	["avarus"] = { price = 350000 },
	["bagger"] = { price = 240000 },
	["bati"] = { price = 82000 },
	["bf400"] = { price = 60000 },
	["carbonrs"] = { price = 70000 },
	["chimera"] = { price = 63000 },
	["cliffhanger"] = { price = 150000 },
	["daemon"] = { price = 55000 },
	["daemon2"] = { price = 120000 },
	["defiler"] = { price = 85000 },
	["diablous"] = { price = 150000 },
	["diablous2"] = { price = 76000 },
	["double"] = { price = 380000 },
	["enduro"] = { price = 160000 },
	["esskey"] = { price = 100000 },
	["faggio3"] = { price = 40000 },
	...
	["hakuchou"] = { price = 150000 },
	["hakuchou2"] = { price = 200000 },
	["hexer"] = { price = 250000 },
	["innovation"] = { price = 120000 },
	["lectro"] = { price = 310000 },
	["manchez"] = { price = 290000 },
	["nemesis"] = { price = 380000 },
	["nightblade"] = { price = 150000 },
	["pcj"] = { price = 220000 },
	["ruffian"] = { price = 280000 },
	["sanchez2"] = { price = 300000 },
	["sanctus"] = {  price = 150000 },
	["sovereign"] = { price = 280000 },
	["thrust"] = { price = 190000 },
	["vader"] = { price = 250000 },
	["vindicator"] = { price = 190000 },
	["vortex"] = { price = 180000 },
	["wolfsbane"] = { price = 230000 },
	["zombiea"] = { price = 120000 },
	["zombieb"] = { price = 120000 },
	["blazer"] = { price = 340000 },
	["blazer4"] = { price = 80000 },
	["coach"] = { price = 20000 },
	["bus"] = { price = 20000 },
	...
	["vwgolf"] = {price = 20000},
	["civic"] = {price = 20000},
	["eletran17"] = {price = 20000},
	["sonata18"] = {price = 20000},
	["veloster"] = {price = 20000}, 
	["monza"] = {price = 20000},
	["p207"] = {price = 20000},
	["vwpolo"] = {price = 20000},
	["evoq"] = {price = 20000},
	...
	["celta"] = {price = 20000},
	["fiat"] = {price = 20000},
	["jetta2017"] = {price = 20000},
	["l200civil"] = {price = 20000},
	["saveiro"] = {price = 20000},
	["upzinho"] = {price = 20000},
	["voyage"] = {price = 20000},
	["golg7"] = {price = 20000},
...
--	["xj"] = {price = 20000},
	...
	["z1000"] = {price = 20000},
	["r1250"] = {price = 20000},
	["ferrariitalia"] = {price = 20000},
	["fordmustang"] = {price = 20000},
	["nissangtr"] = {price = 20000},
	["nissangtrnismo"] = {price = 20000},
	["teslaprior"] = {price = 20000},
	["nissanskyliner34"] = {price = 20000},
	["audirs6"] = {price = 20000},
	["bmwm3f80"] = {price = 20000},
	["bmwm4gts"] = {price = 20000},
	["lancerevolutionx"] = {price = 20000},
	["toyotasupra"] = {price = 20000},
	["nissan370z"] = {price = 20000},
	["lamborghinihuracan"] = {price = 20000},
	["dodgechargersrt"] = {price = 20000},
	["mazdarx7"] = {price = 20000},
	["siciliana"] = {price = 20000}
}
			...
			menu["Possuídos"] = { function(player,choice)
				...
				if user_id then
					...
					local choose = function(player,choice)
						...
						if vname then
							...
							if not payprice then
								...
								if (vRP.getBankMoney(user_id)+vRP.getMoney(user_id)) >= parseInt(carros[vname].price*0) then
									vRP.closeMenu(source)
									local cond,netid,carname = vRPgarage.spawnGarageVehicle(source,vname,custom,parseInt(rows[1].engine),parseInt(rows[1].body),parseInt(rows[1].fuel),parseInt(location))
									if cond and vRP.tryFullPayment(user_id,parseInt(carros[vname].price*0)) then
										idveh[netid] = { user_id,carname }
									else
										TriggerClientEvent("Notify",source,"aviso","Já tem um veículo deste modelo fora da garagem.")
									end
					...
					local choosedetidotime = function(source,choice)
						local vname = kitems[choice]
						if vname then
							local ok = vRP.request(source,"Veículo na retenção, deseja acionar o seguro pagando <b>$"..vRP.format(parseInt(carros[vname].price*0.2)).."</b> dólares?",60)
							if ok then
					...
					for k,v in pairs(pvehicles) do
						...
						if vehicle then
							...
							if parseInt(rows[1].detido) <= 0 then
								submenu[vehicle[1]] = { choose,"<text01>Lataria:</text01> <text02>"..vRP.format(parseInt(rows[1].body*0.1)).."%</text02><text01>Motor:</text01> <text02>"..vRP.format(parseInt(rows[1].engine*0.1)).."%</text02><text01>Gasolina:</text01> <text02>"..vRP.format(parseInt(rows[1].fuel)).."%</text02><text01>r:</text01> <text02>$"..vRP.format(parseInt(carros[rows[1].vehicle].price*0.000)).."</text02><text01>Detenção:</text01> <text02>$"..vRP.format(parseInt(carros[rows[1].vehicle].price*0.1)).."</text02><text01>Retenção:</text01> <text02>$"..vRP.format(parseInt(carros[rows[1].vehicle].price*0.5)).."</text02>" }
							else
								if os.time() <= parseInt(rows[1].time+24*60*60) then
									submenu[vehicle[1]] = { choosedetidotime,"<text01>Lataria:</text01> <text02>"..vRP.format(parseInt(rows[1].body*0.1)).."%</text02><text01>Motor:</text01> <text02>"..vRP.format(parseInt(rows[1].engine*0.1)).."%</text02><text01>Gasolina:</text01> <text02>"..vRP.format(parseInt(rows[1].fuel)).."%</text02><text01>Seguro:</text01> <text02>$"..vRP.format(parseInt(carros[rows[1].vehicle].price*0.002)).."</text02><text01>Detenção:</text01> <text02>$"..vRP.format(parseInt(carros[rows[1].vehicle].price*0.1)).."</text02><text01>Retenção:</text01> <text02>$"..vRP.format(parseInt(carros[rows[1].vehicle].price*0.5)).."</text02>" }
								else
							...
							if vehicle then
								...
								if ok then
									...
									if vehicle[4] ~= -1 and parseInt(rows[1].qtd) >= vehicle[4] then
										...
										if vRP.hasPermission(user_id,"iron.permissao") then
										...
										elseif vRP.hasPermission(user_id,"diamond.permissao") then
											if parseInt(totalv[1].quantidade) >= totalgaragem + 7 then
												TriggerClientEvent("Notify",source,"importante","Atingiu o número máximo de veículos em sua garagem.")
												return
											end
										elseif vRP.hasPermission(user_id,"hero.permissao") then
						...
						if custom then
							if vRP.tryFullPayment(user_id,5000) then
								if vname then
									...
									TriggerClientEvent("Notify",player,"sucesso","Pagou <b>$5.000 dólares</b>.")
								end
							else
								vRPgarage.setVehicleMods(source,old_custom)
								TriggerClientEvent("Notify",player,"negado","Dinheiro insuficiente.")
		...
		local choose = function(source,choice)
			...
			local ch_sell = function(source,choice)
				...
				if nplayer then
					...
					if vRP.hasPermission(tuser_id,"iron.permissao") then
						if parseInt(totalv[1].quantidade) >= totalgaragem + 3 then
							TriggerClientEvent("Notify",source,"importante","A pessoa atingiu o número máximo de veículos na garagem.")
							return
						end
					elseif vRP.hasPermission(tuser_id,"gold.permissao") then
						if parseInt(totalv[1].quantidade) >= totalgaragem + 5 then
							TriggerClientEvent("Notify",source,"importante","A pessoa atingiu o número máximo de veículos na garagem.")
							return
						end
					elseif vRP.hasPermission(tuser_id,"diamond.permissao") then
						if parseInt(totalv[1].quantidade) >= totalgaragem + 7 then
							TriggerClientEvent("Notify",source,"importante","A pessoa atingiu o número máximo de veículos na garagem.")
							return
						end
					elseif vRP.hasPermission(tuser_id,"hero.permissao") then
						if parseInt(totalv[1].quantidade) >= totalgaragem + 10 then
							TriggerClientEvent("Notify",source,"importante","A pessoa atingiu o número máximo de veículos na garagem.")
							return
						end
						...
						if ok then
							if parseInt(price) > 0 then
								if vRP.tryFullPayment(tuser_id,parseInt(price)) then
									...
									local identitytu = vRP.getUserIdentity(tuser_id)
...
AddEventHandler("buttonTrunk",function()
	...
	if not mLock then
		if mPlaca then
			if mName then
				if mBanido then
					TriggerClientEvent("Notify",source,"negado","Em veículos de trabalho ou alugados não é permitido usar o porta-malas.")
					return
				end
				local mPlacaUser = vRP.getUserByRegistration(mPlaca)
				if mPlacaUser then
